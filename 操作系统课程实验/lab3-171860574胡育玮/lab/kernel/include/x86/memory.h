...
#define SEG_KCODE   1           // Kernel code：内核代码
#define SEG_KDATA   2           // Kernel data/stack：内核数据
#define SEG_TSS     (NR_SEGMENTS-1)

// Selectors
#define KSEL(desc) (((desc) << 3) | DPL_KERN)  //内核段选择符
#define USEL(desc) (((desc) << 3) | DPL_USER)  //用户段选择符
...
#define MAX_PCB_NUM ((NR_SEGMENTS-2)/2) // = 4
